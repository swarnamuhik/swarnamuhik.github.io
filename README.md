...
- **Skills section**  she powers up: bigger size, a sparkle trail, and a slightly higher jump.
- **Education section**  she puts on a graduation cap and gets the same sparkle/higher-jump treatment.
- **Experience section**  a small yellow toy construction truck drives back and forth in the background, a nod to the Caterpillar role.

It's a normal one-page resume site with a game's worth of personality.
